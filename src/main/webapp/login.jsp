...
<head>
    ...
    <style>
        ...
        .body {
            ...
            width: auto;
            height: auto;
            background-image: url('${ctx}/login/city-skyline-wallpapers-008.jpg');
    ...
    <script src="${ctx}/login/prefixfree.min.js"></script>
...
<script src='${ctx}/res/js/jquery-1.11.2.js'></script>
